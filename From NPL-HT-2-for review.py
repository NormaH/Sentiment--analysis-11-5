...
# Making the Confusion Matrix; assessing  accuracy of the model (recommend to review it to identify if the model may improve with more data over time)
...
def report1 (df1):
    if df1[: ,2] ==1:
        print ("The suscriber is positive, in good track")
       
    else:
        print("The suscriber is not in a favorable track")
